...
326. ### 新的 JSX 转换器有什么优点？
     ...
     1.  不需要引入React包就可以使用JSX了
     2.  稍微优化了输出文件的体积
     3.  这个功能提高了 JSX 的灵活性，减少了学习 react 这项成本。
...
328. ### How do you get redux scaffolding using create-react-app?
    ...
    Redux团队提供了官方的 redux+js/redux+typescript 的 CRA（create-react-app） 模版。它构建的配置项包括:
     ...
     ````
329. ### 什么是 React Server components?

    React Server Component 是一种编写 React component 的方法，它通过在服务端渲染组件来提高 React 程序的性能。这些组件允许我们从后端加载组件。
     **Note:** React Server Components 仍停留在开发阶段，不建议在生产中使用。
